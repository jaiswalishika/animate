...
const Reviews = () => {
    ...
    return (
        <div className='w-full py-[10rem] px-4 bg-blue-200'> <h1 className='md:text-3xl  text-3xl font-semibold m-10 py-10'><span className='text-blue-900 font-bold'>INSPIRING </span> THE NEXT WAVE OF <span className='text-blue-900 font-bold'> PASSIONATE </span> AND PRODUCTION READY <span className='text-blue-900 font-bold'> ARTISTS.</span></h1>
